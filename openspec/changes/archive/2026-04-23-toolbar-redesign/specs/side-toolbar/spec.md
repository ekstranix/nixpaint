...
The application SHALL display a vertical toolbar on the left side of the canvas containing tool selection buttons.

#### Scenario: Side toolbar is visible
- **WHEN** the application loads
- **THEN** a narrow vertical toolbar is visible on the left edge, containing Paint, Erase, and Pan tool buttons
...
- **THEN** a tooltip displaying the tool name (e.g., "Paint", "Erase", "Pan") SHALL appear
